...
* The following dependencies are not known to work with Spring Native: 'MS SQL Server Driver, Spring Boot DevTools'. As
...
```
$ docker run --rm -p 8080:8080 IBLTest:0.0.1-SNAPSHOT
```
